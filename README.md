...
Official references: [Ollama Qwen3:8b](https://ollama.com/library/Qwen3:8b), [Ollama Chat API](https://docs.ollama.com/api/chat), [Ollama FAQ](https://docs.ollama.com/faq).
